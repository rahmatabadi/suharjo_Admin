...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Suharjo Registration';
            $this->load->view('templates/auth_header', $data);
            ...
            Congratulation your account has been created. Pleas activate your account </div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'dev.suharjo@gmail.com',
            'smtp_pass' => 'Suh@rj01997',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('dev.suharjo@google.com', 'CV Abadi Suharjo');
    ...
    public function changePassword()
    {
        ...
        $this->form_validation->set_rules('newPassword2', 'Confrim Password', 'required|trim|min_length[3]|matches[newPassword1]');
